...
class Organization(Base, TimestampMixin):
    ...
    max_branches: Mapped[int | None] = mapped_column(Integer, default=1, nullable=True)
    max_users: Mapped[int | None] = mapped_column(Integer, default=5, nullable=True)
    max_products: Mapped[int | None] = mapped_column(Integer, default=500, nullable=True)
